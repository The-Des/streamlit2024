...
if uploaded_file:
    ...
    st.write("Horarios de entrada en formato datetime64[ns]:")
    st.dataframe(entry_times_datetime64)

    # Guardar el resultado en memoria
    st.session_state['entry_times'] = entry_times_datetime64
